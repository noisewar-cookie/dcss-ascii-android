...
//    private static final int[] LONG_PRESSABLE_STATE_SET = { R.attr.state_long_pressable };   
    ...
    private CrawlKeyboardView mMiniKeyboard;
    ...
    public CrawlKeyboardView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.keyboardViewStyle);
    }

    public CrawlKeyboardView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a =
            context.obtainStyledAttributes(
                attrs, R.styleable.CrawlKeyboardView, defStyle, 0);
        ...
        //TODO: What is this dim amount thing??
...
//                com.android.internal.R.bool.config_swipeDisambiguation);
     ...
     * @see CrawlKeyboardView#isShifted()
     */
     ...
     * @see CrawlKeyboardView#setShifted(boolean)
     */
...
//                mMiniKeyboard = (CrawlKeyboardView) mMiniKeyboardContainer.findViewById(
//                        android.internal.R.id.keyboardView);
